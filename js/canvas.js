    ...
    function createDynamicElement(childData, cs, block) {
        ...
        if (type === 'img') {
            ...
            if (type === 'add-to-cart') {
                ...
                childEl.style.cssText = 'padding:10px 20px;background:var(--accent, #6c63ff);color:#fff;border:none;border-radius:6px;cursor:pointer;font-size:1rem;';
                ...
                childEl.innerText = cs.text || childData.props.text || 'Button';
                childEl.style.cssText = 'padding:10px 20px;background:var(--accent, #6c63ff);color:#fff;border:none;border-radius:6px;cursor:pointer;font-size:1rem;text-decoration:none;display:inline-flex;align-items:center;justify-content:center;';
            }
            }
